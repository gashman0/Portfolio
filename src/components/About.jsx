...
const About = () => {
  ...
  return (
    <>
      ...
      >
        {/* About */}
        <h2 className="mb-6 text-2xl text-[#f1f1f1] sm:text-3xl md:text-4xl lg:text-[3rem]">
        ...
        <p className="text-justify text-base leading-relaxed text-[#ebebeb] sm:text-lg md:text-2xl">
          I'm Agashi Victor Tochukwu, also known as Gashman, a full-stack
          developer focused on building modern web applications. I started out
          building simple interfaces with Javascript and React, and over the
          past two years I have grown into building full web applications used
          in real environments. Currently, I work with a fintech startup where I
          contribute to developing products that people actually rely on. That
          experience has pushed me to think beyond just UI, I now look at
          ...
          applications I build. I care about doing things properly, writing
          clean code, and getting better every day.
        </p>

        {/* Skills */}
        <h2 className="mb-6 mt-12 text-2xl text-[#f1f1f1] sm:text-3xl lg:text-[3rem]">
          My Skills
        </h2>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {[
            ...
            { name: "React", value: "70%" },
            { name: "HTML, CSS, and Tailwind CSS", value: "90%" },
        ...
        {/* Pricing */}
        <h2 className="mb-6 mt-16 text-2xl text-[#f1f1f1] sm:text-3xl lg:text-[3rem]">
          My Pricing
        </h2>
